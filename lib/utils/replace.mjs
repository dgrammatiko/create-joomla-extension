...
function replaceTags(originalSource, ans) {
  ...
  const pairs = [
    ...
    {search: '{{extensionNameLowercase}}', change: name.toLowerCase()},
    {search: '{{extensionNameUppercase}}', change: name.toLowerCase()},
    ...
    {search: '{{clientNameUppercase}}', change: ans.client ? ans.client.toLowerCase() : ''},
  ];
